        ...
        public static void EnsureDatabaseSeeded(this DispatcherContext context)
        {
            ...
            if (!context.Pilots.Any())
            {
                context.Pilots.AddRange(new List<Pilot>
                    {
                        new Pilot{FirstName="Tom",LastName="Piton",BirthDate=new DateTime(1998,12,07),Experience=1,CrewId=1},
                        new Pilot{FirstName="Ted",LastName="Pen",BirthDate=new DateTime(1998,12,07),Experience=2,CrewId=2},
                        new Pilot{FirstName="Pavlo",LastName="Toden",BirthDate=new DateTime(1998,12,07),Experience=3,CrewId=3}
                    });
                context.SaveChanges();
            }
            ...
            if (!context.Stewardesses.Any())
            {
                context.Stewardesses.AddRange(new List<Stewardess>
                    {
                        new Stewardess{FirstName="Anna",LastName="Piton",BirthDate=new DateTime(1998,12,07),CrewId=1},
                        new Stewardess{FirstName="Oly",LastName="Pen",BirthDate=new DateTime(1998,12,07),CrewId=2},
                        new Stewardess{FirstName="Hana",LastName="Toden",BirthDate=new DateTime(1998,12,07),CrewId=3}
                    });
                context.SaveChanges();
            }
